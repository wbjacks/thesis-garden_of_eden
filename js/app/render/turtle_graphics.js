...
Turtle._F = function _F(time) {
    ...
    // TODO: Move this to a matrix.compose
...
// TODO: Build a seed module to run lsystem from within forest, return a seed
// data object to hold actions and position
Turtle.prototype.run = function(actions, seed) {
    // Build tree
    ...
    // Use seed to move into position
    var worldTransform = new THREE.Matrix4().compose(
        new THREE.Vector3(seed.x, seed.y, seed.z),
        // TODO use set from Axis angle?
        new THREE.Quaternion().setFromEuler(new THREE.Euler(-Math.PI/2)),
        new THREE.Vector3(1, 1, 1)

    );
    this.geometry.applyMatrix(worldTransform);
...
Turtle.prototype.executeActions = function(actions) {
