...
$(1.3856, 2.0784)$.
% Revisit this with concerns over elongation <1, consider clamping to 1 on bottom end

    % not sure what to do about divergence angle

    % Specify type of tree, measure examples from that type
    % 20% branch length mentioned, should be the same for height
